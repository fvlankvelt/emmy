...
import emmy.autodiff.{ CategoricalVariable, ContainerOps, Evaluable, GradientContext, Expression, Floating, Node, ScalarOps, ValueOps }
...
//
//    override def apply(ec: GradientContext) = value
//
//    override def logp = ???
//
...
//
//      override def apply(ec: GradientContext): Scalaz.Id[Double] = {
